...
namespace University.ViewModels
{
    public class BookViewModel : ViewModelBase
    {
        ...
        private void AddNewBook(object? obj)
        {
            ...
            {
                instance.BookSubView = new AddBookViewModel(_context, _dialogService);
            }
        }
        ...
        private void EditBook(object? obj)
        {
            if (obj is not null)
            {
                ...
                if (instance is not null)
                {
                    instance.BookSubView = editBookViewModel;
                }
            }
        }
        ...
        private void RemoveBook(object? obj)
        {
            if (obj is not null)
            {
                ...
                if (book is not null)
                {
                    DialogResult = _dialogService.Show(book.Title + " " + book.Description);
        ...
        public BookViewModel(UniversityContext context, IDialogService dialogService)
        {
            _context = context;
